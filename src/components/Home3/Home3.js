  ...
  return (
    <ThemeProvider theme={theme}>
      <>
        <Transitions>
          <video
            src="https://firebasestorage.googleapis.com/v0/b/heterometadev-4d7aa.appspot.com/o/SAHNE%203%20C%CC%A7O%CC%88L.mp4?alt=media&token=8f37900f-4772-4fd5-a175-dd3d88e6203d"
            playsinline="true"
          ...
          {/* <div ref={$root} className={classes.root}>
            <div className={classes.video}>
              ...
              >
                <source
                  src="/Videos/SAHNE 3 ÇÖLDE GEÇİT.mp4"
                  type="video/mp4"
                />
              </video>
                      ...
                      >
                        <div class="boxContainer2">
                          ...
                          <div className="boxCenter2">
                            <Menu></Menu>
                            <a href="/4" class="animated-button10">
                              <span></span>
                              <span></span>
                              <span></span>
                              <span></span>
